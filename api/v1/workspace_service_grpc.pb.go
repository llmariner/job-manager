...
func (c *workspaceServiceClient) StopNotebook(ctx context.Context, in *StopNotebookRequest, opts ...grpc.CallOption) (*StopNotebookResponse, error) {
	out := new(StopNotebookResponse)
