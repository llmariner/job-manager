...
const (
	WorkspaceWorkerService_ListQueuedInternalNotebooks_FullMethodName = "/llmoperator.workspace.server.v1.WorkspaceWorkerService/ListQueuedInternalNotebooks"
	WorkspaceWorkerService_UpdateNotebookState_FullMethodName         = "/llmoperator.workspace.server.v1.WorkspaceWorkerService/UpdateNotebookState"
)
...
func (c *workspaceWorkerServiceClient) ListQueuedInternalNotebooks(ctx context.Context, in *ListQueuedInternalNotebooksRequest, opts ...grpc.CallOption) (*ListQueuedInternalNotebooksResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkspaceWorkerService_ListQueuedInternalNotebooks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workspaceWorkerServiceClient) UpdateNotebookState(ctx context.Context, in *UpdateNotebookStateRequest, opts ...grpc.CallOption) (*UpdateNotebookStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkspaceWorkerService_UpdateNotebookState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkspaceWorkerService_ListQueuedInternalNotebooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkspaceWorkerService_ListQueuedInternalNotebooks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkspaceWorkerService_UpdateNotebookState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkspaceWorkerService_UpdateNotebookState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
